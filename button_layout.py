...
class ButtonLayout:
    # mapping = {0: "None", 1: "Bad", 2:"Not Bad", 3:"OK", 4:"Good", 5:"Perfect"}
    ...
    #rev_mapping = {"None": 0, "Bad":1 , "Not Bad": 2, "OK": 3, "Good": 4, "Perfect": 5}
    ...
    def __init__(self, case_notification, annotation):
        ...
        if annotation is not None:
            ...
            self.cur_case_type = self.rev_mapping.get(annotation["TypeData"], "not_view")

            self.cur_case_comments = annotation["Comments"]
            self.cur_case_chambers = annotation["Chambers"]
        else:
    ...
    def __init_layout(self):
        ...
        # self.chambers_comment = [self.chambers, self.comment]
